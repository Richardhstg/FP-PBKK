...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
    ...
    <header id="header" class="site-header header-scrolled position-fixed text-light bg-black">
        <nav id="header-nav" class="navbar navbar-expand-lg px-2 my-2">
            <div class="container-fluid">
                <a class="navbar-brand">
                    <img src="/images/logos.png" alt="" style="width: 140px;" />
                </a>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul id="navbar"
                            ...
                            {{-- <li class="nav-item">
                                <a class="nav-link me-4" href="{{ route('home') }}#company-services">Services</a>
                            </li> --}}
                            <li class="nav-item">
                                <a class="nav-link me-4" href="{{ route('home') }}#mobile-products">Smartphone</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link me-4" href="{{ route('home') }}#yearly-sale">Sale</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link me-4" href="{{ route('shop') }}">Shop</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link me-0 dropdown-toggle link-dark" data-bs-toggle="dropdown"
                                    href="#" role="button" aria-expanded="false">Other</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="{{ route('order-status') }}" class="dropdown-item">My Order</a>
                                    </li>
                                    <li>
                            ...
                            {{-- <li class="nav-item dropdown">
                            <a class="nav-link mx-0 dropdown-toggle link-dark" data-bs-toggle="dropdown"
                                href="#" role="button" aria-expanded="false">
                                <svg class="user" width="45px" height="20px">
                                    <use xlink:href="#user"></use>
                                </svg></a>
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="{{ route('about') }}" class="dropdown-item">Edit</a>
                                </li>
                                <li>
                                    <a href="{{ route('about') }}" class="dropdown-item">Logout</a>
                                </li>
                            </ul>
                        </li> --}}
                            @if (Auth::check())
                                <li class="nav-item d-flex align-items-center">
                                    <a href="{{ route('logout') }}"
                                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><button
                                            type="button" class="btn btn-light mx-3">Log
                                            Out</button></a>
                                    <form id="logout-form" action="{{ route('logout') }}" method="POST"
                                        style="display: none;">
                                        @csrf
                                    </form>
                                    <p class="mt-3 fs-6">{{ Auth::user()->name }}</p>
                                            ...
                                            <li>
                                                <a href="{{ route('order-status') }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" fill="currentColor" class="bi bi-box2-fill"
                                                        viewBox="0 0 16 16">
                                                        <path
                            ...
                            @else
                                <li class="nav-item d-flex align-items-center">
                                    <a href="{{ route('login') }}"><button type="button"
                                            class="btn btn-light mx-3">Login</button></a>
                                    <a href="{{ route('register') }}"><button type="button"
                                            class="btn btn-light mx-0">Register</button></a>
                                </li>
                            @endif
                        </ul>
                    </div>
  ...
  <div class="offcanvas-body p-0 d-flex flex-column">
    ...
    <section id="subscribe" class="container-grid padding-large position-relative overflow-hidden">
        <div class="container">
            <div class="row">
                <div
                    class="subscribe-content d-flex flex-wrap justify-content-center align-items-center padding-medium">
    ...
    <section id="instagram" class="padding-large overflow-hidden no-padding-top">
        <div class="container">
            <div class="row">
                <div class="display-header text-uppercase text-white text-center pb-3">
                    <h2 class="display-7">Visit Our Insta</h2>
                </div>
                <div class="d-flex flex-wrap">
                    <figure class="instagram-item pe-2">
                        <a href="https://www.instagram.com/" target="_blank" class="image-link position-relative">
        ...
        <div class="container">
            <div class="row">
                <div class="footer-top-area">
                    <div class="row d-flex flex-wrap justify-content-between text-white">
                        <div class="col-lg-3 col-sm-6 pb-3">
                            <div class="footer-menu">
                                <span>AITronics</span>
                                <p>AITronics delivers quality, affordable, innovative products with fast delivery,
                                    secure payments,
                                    eco-friendly
                                    packaging, and reliable support.
                                </p>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-3">
                            <div class="footer-menu contact-item">
                                ...
                                <p>Do you have any queries or suggestions? <a href="mailto:">cs@aitronics.com</a>
                                </p>
                                <p>If you need support? Just give us a call. <a href="">+62 811 223</a>
                                </p>
                            </div>
                        </div>
                    </div>
